...
# --- SET PAGE CONFIG --- # 
st.set_page_config(page_title="BenjaminCodeGPT", page_icon=":computer:", initial_sidebar_state="collapsed") #  💻	:shield:
...
if not st.session_state.submitted_query:
    ...
    with col2:
        ...
        col2.write("Bonjour ! Je suis BenjaminCodeGPT, une IA entraînée sur les superbes vidéos de [ma chaîne YouTube](https://www.youtube.com/channel/UCLOAPb7ATQUs_nDs9ViLcMw), sur laquelle je parle de mon amour pour **VueJS**, de mon SaaS [MeetSponsors](https://meetsponsors.com/), et bien plus encore. Posez-moi vos questions, et je ferai de mon mieux pour y répondre en vous fournissant les liens de vidéos pertinentes pour approfondir le sujet.")
...
def generate_response():
    ...
    with col2:
        ...
        col2.write("Salut ! je suis BenjaminCodeGPT, votre assistant IA dédié à l'univers du développement web et de l'entrepreneuriat tech. J'ai été entraîné sur les vidéos de ma chaîne YouTube où je partage mes expériences de freelance, de création de produits tech, ainsi que l'aventure entrepreunariale de mon SaaS [MeetSponsor](https://meetsponsors.com/). Posez-moi vos questions sur le développement, la gestion de projet, ou même la création de contenu, et je ferai de mon mieux pour vous répondre en vous fournissant des conseils pratiques et des ressources utiles.")
